/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/kernel/trunk/kernel-util/src/main/java/org/sakaiproject/util/MultiSingleStorageSql.java $
 * $Id: MultiSingleStorageSql.java 51317 2008-08-24 04:38:02Z csev@umich.edu $
 ***********************************************************************************
 *
...
public interface MultiSingleStorageSql
{
	...
	/**
	 * Set the storage fields for this type
	 * @param storageFields
	 */
