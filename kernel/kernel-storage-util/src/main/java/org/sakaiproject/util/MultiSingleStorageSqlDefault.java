/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/kernel/trunk/kernel-util/src/main/java/org/sakaiproject/util/MultiSingleStorageSqlDefault.java $
 * $Id: MultiSingleStorageSqlDefault.java 51317 2008-08-24 04:38:02Z csev@umich.edu $
 ***********************************************************************************
 *
 ...
 */
public class MultiSingleStorageSqlDefault implements MultiSingleStorageSql
{
	protected String storageFields= "XML";

	/**
	 * @param storage_fields
	 */
	public MultiSingleStorageSqlDefault(String storageFields)
	{
	...
	{
		return "select "+storageFields+" from " + table;
	}
	...
	{
		return "select limit " + (first - 1) + " " + (last - first + 1) + " "+storageFields+" from " + table + " order by " + field + " asc";
	}
	...
	/* (non-Javadoc)
	 * @see org.sakaiproject.util.MultiSingleStorageSql#setStorageFields(java.lang.String)
	 */
