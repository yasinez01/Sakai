...
INSERT INTO SAKAI_SITE VALUES('~admin', 'Admin Home', null, null, 'Admin Home', null, null, null, 1, 0, 0, '', 'admin', 'admin', NOW(), NOW(), 0, 1, 0, 0, null);
...
INSERT INTO SAKAI_SITE VALUES('!plussite', 'plussite', 'course', 'SakaiPlus Template', 'Default template used when SakaiPlus creates a new site', null, null, null, 0, 0, 0, 'access', 'admin', 'admin', NOW(), NOW(), 1, 0, 1, 0, null);
